...
const projects = [
  {
    ...
    techno:[html,css,js,git,github,figma,npm,bash]
  },

  {
    ...
    techno:[html,css,js,git,github,npm,bash,leaflet]
  },
  {
    name: "Star-Wild",
    img: starwild,
    ...
    techno:[html,css,js,git,github,npm,bash,react,sass,threejs]
  },
  {
    name: "AgendStrauss",
    img: agendstrauss,
    ...
    repo: "https://github.com/Sachdarras/agendStrauss",
     techno:[html,css,js,git,github,npm,bash,react,sass]
  },
  {
